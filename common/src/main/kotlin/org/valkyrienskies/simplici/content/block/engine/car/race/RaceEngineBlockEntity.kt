...
class RaceEngineBlockEntity(pos: BlockPos, state: BlockState) : EngineBlockEntity(ModBlockEntities.RACE_ENGINE.get(), pos, state) {
    override var maxPowerKey: GameRules.Key<GameRules.IntegerValue> = ModGamerules.RACE_ENGINE_MAX_POWER
    override var maxSpeedKey: GameRules.Key<GameRules.IntegerValue> = ModGamerules.RACE_ENGINE_MAX_SPEED
