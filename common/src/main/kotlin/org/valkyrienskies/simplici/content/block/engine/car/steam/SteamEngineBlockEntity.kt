...
class SteamEngineBlockEntity(pos: BlockPos, state: BlockState) : EngineBlockEntity(ModBlockEntities.STEAM_ENGINE.get(), pos, state) {
    override var maxPowerKey: GameRules.Key<GameRules.IntegerValue> = ModGamerules.STEAM_ENGINE_MAX_POWER
    override var maxSpeedKey: GameRules.Key<GameRules.IntegerValue> = ModGamerules.STEAM_ENGINE_MAX_SPEED
    override val powerCurve: InterpolationCurve = InterpolationCurve()

    override val fuelDefaultName: String = "steam_engine"

    init {
        //TODO: update power curve
        // X is speed Y is torque output
